...
- [2.4 数据收集](#2.4-数据收集)
  ...
  - **开发环境的性能检查**：使用 Lighthouse.js 进行开发环境中的性能检查。
  - **生产环境的性能监控**：使用 Web Vitals.js 监控生产环境中的性能。
